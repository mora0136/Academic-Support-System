    ...
    public static void main(String[] args) throws Exception{
        SwingUtilities.invokeAndWait(new Runnable(){
            ...
            public void run() {
                ...
                JButton testBtn = new JButton("I'm a Button");
                testBtn.setFont(new Font("Arial", Font.PLAIN, 32));
                testBtn.setPreferredSize(new Dimension(500, 100));
                testBtn.setMinimumSize(new Dimension(50, 50));
